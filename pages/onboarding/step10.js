...
class Step10 extends React.Component {
  ...
  componentDidMount() {
    ...
    if (window.localStorage.getItem("paymentMethod")) {
      storedPaymentMethod = JSON.parse(
          ...
          render={props => (
            <Form>
              ...
              <Button
                primary
                disabled={
                  !!props.values.bankName !== true ||
                  !!props.values.bankRoutingNumber !== true ||
                  !!props.values.bankAccountNumber !== true ||
                  !!props.values.bankAccountNumberConfirmation !== true
                }
              >
                Next
              </Button>
